...
public class VirtualPetShelterTest {
	...
	public void shouldGetStatusNoPets() {
		...
		String status = underTest.toString();
	...
	@Test
	public void shouldNotProduceErrorWhenPlayingWithNonExistentPet() {
		underTestState.play("does not exist");
	}

	@Test
	public void shouldNotProduceErrorWhenAdoptingANonExistentPet() {
		underTestState.adoptPet("does not exist");
	}
